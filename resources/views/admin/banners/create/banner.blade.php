    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form action="{{ route('cabinet.banners.store', [$category, $region]) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control{{ $errors->has('file') ? ' is-invalid' : '' }}" id="file" name="file" value="{{ old('file') }}" required>
                            @error('file')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
